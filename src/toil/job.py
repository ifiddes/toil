...
class ResourceRequirementMixin(object):
    ...
    properties insure that even if the user does not pass a resource requirement the
    default value will be available when the user's code is run in Job.run or in
    Job.Service.start. If the value cannot be determined an AttributeError is raised.
    """
